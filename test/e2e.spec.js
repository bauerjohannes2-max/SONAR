...
test.describe('SONAR v1.19.0 Tactical Gauntlet Loop E2E Validation', () => {
  ...
  test('47. Gameplay-Juice Update: Safe-Area Action Cluster, Haptics Engine, Danger-Vignette Proximity, Delicate Bubble Particles & Quick Restart (v1.19.0)', async ({ page }) => {
    await page.goto('/');
